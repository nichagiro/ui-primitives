import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{A as n,t as r}from"./iframe-Cite5768.js";import{t as i}from"./react-dom-C23B43gk.js";import{a,d as o,f as s,o as c,p as l,s as u}from"./Icons-Btyb2xif.js";import{n as d,t as f}from"./Button-BhYRqPOn.js";function p(){return _}function m(e){let t=`toast-${++y}`;return _=[..._,{...e,id:t}],v.forEach(e=>e()),t}function h(e){_=_.filter(t=>t.id!==e),v.forEach(e=>e())}function g(e){return v.push(e),()=>{v=v.filter(t=>t!==e)}}var _,v,y,b,x=e((()=>{_=[],v=[],y=0,b={success:(e,t)=>m({message:e,variant:`success`,duration:t??4e3}),error:(e,t)=>m({message:e,variant:`danger`,duration:t??5e3}),info:(e,t)=>m({message:e,variant:`info`,duration:t??4e3}),warning:(e,t)=>m({message:e,variant:`warning`,duration:t??4e3}),dismiss:e=>h(e)}}));function S({id:e,message:t,variant:n,duration:r}){let i=(0,C.useCallback)(()=>h(e),[e]);return(0,w.jsxs)(`div`,{role:`alert`,className:[`relative flex items-start gap-3 overflow-hidden rounded-xl border bg-card p-4 pr-11 text-sm shadow-lg`,E[n]??``,`animate-[rhf-toastIn_300ms_ease-out]`].join(` `),children:[T[n]??null,(0,w.jsx)(`p`,{className:`flex-1 pt-0.5 text-foreground`,children:t}),(0,w.jsx)(`button`,{type:`button`,onClick:i,className:`absolute right-3 top-3 rounded p-0.5 text-muted-foreground transition-colors hover:text-foreground`,"aria-label":`Cerrar`,children:(0,w.jsx)(a,{className:`h-4 w-4`})}),(0,w.jsx)(`span`,{className:[`absolute bottom-0 left-0 h-0.75`,D[n]??``,`animate-[rhf-toastProgress_var(--duration)_linear]`].join(` `),style:{"--duration":`${r}ms`},onAnimationEnd:i})]})}var C,w,T,E,D,O=e((()=>{C=t(n(),1),x(),l(),w=r(),T={info:(0,w.jsx)(u,{className:`h-5 w-5 shrink-0`}),success:(0,w.jsx)(o,{className:`h-5 w-5 shrink-0`}),warning:(0,w.jsx)(s,{className:`h-5 w-5 shrink-0`}),danger:(0,w.jsx)(c,{className:`h-5 w-5 shrink-0`})},E={info:`border-info/30 bg-info/10 text-info`,success:`border-success/30 bg-success/10 text-success`,warning:`border-warning/30 bg-warning/10 text-warning`,danger:`border-danger/30 bg-danger/10 text-danger`},D={info:`bg-info`,success:`bg-success`,warning:`bg-warning`,danger:`bg-danger`},S.__docgenInfo={description:``,methods:[],displayName:`ToastItem`,props:{id:{required:!0,tsType:{name:`string`},description:``},message:{required:!0,tsType:{name:`string`},description:``},variant:{required:!0,tsType:{name:`union`,raw:`'primary' | 'secondary' | 'success' | 'warning' | 'danger' | 'info'`,elements:[{name:`literal`,value:`'primary'`},{name:`literal`,value:`'secondary'`},{name:`literal`,value:`'success'`},{name:`literal`,value:`'warning'`},{name:`literal`,value:`'danger'`},{name:`literal`,value:`'info'`}]},description:``},duration:{required:!0,tsType:{name:`number`},description:``}}}}));function k(){if(document.getElementById(P))return;let e=document.createElement(`style`);e.id=P,e.textContent=`
